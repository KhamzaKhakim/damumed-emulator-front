...
export const ExternalAppSessionItem = ({ externalAppSession }: Props) => {
    ...
    <>
      <div className={classes.container}>
        ...
        <div className={classes.fields}>
          <p>
            &quot;externalAppSystemUsername&quot; :{" "}
            <span className={classes.value}>
              &quot;{externalAppSession.externalAppSystemUsername}&quot;
            </span>
          </p>
          <p>
            &quot;validUntil&quot; :{" "}
            <span className={classes.value}>
              &quot;{externalAppSession.validUntil}&quot;
            </span>
          </p>
        </div>
        <div className={classes.fields}>
