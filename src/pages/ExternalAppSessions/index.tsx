...
export default function ExternalAppSessions() {
  ...
  const currentExternalApps = externalAppQuery.data?.slice(
    firstExternalAppIndex,
    lastExternalAppIndex
  );

  return (
    <>
      <div className={classes.colFlex}>
        <Link to="/create-external-app-session" className={classes.createLink}>
          ADD NEW EXTERNAL APP SESSION
